...
#FINAL CON CICLO PUNTAJE Y VALIDACIONES DE LA ELECCION DEL 0 al 5
...
while eleccionUsuario!= 0:
    if eleccionUsuario< 0 or eleccionUsuario> 5:
        print("Debes elegir uno de los escondites que te indique (del 1 al 5). Elige nuevamente uno.")
        eleccionUsuario = int(input("Por favor dime donde crees que arturo se escondió (del 1 al 5) o escribe 0 para salir:"))
        # Arturo elige un escondite
        esconditeArturo = random.randint(1, 5)
    else:
